...
### Plot Three
```{r echo=FALSE,Plots3,message=FALSE, warning=FALSE}
create_ggplot1 <- function(variable,n) 
  return(ggplot(aes(x = redwine$quality, y = variable), data = redwine)+
          geom_jitter(alpha = 1/3) +
          geom_smooth(method = "lm", aes(group = 1))+
...
### Description Three
This plot gives clear idea about how volatile acidity,citric acid affect wine quality.
